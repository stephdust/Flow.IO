#pragma once
    ...
    (defined(FLOW_PROFILE_FLOWIO) && defined(FLOW_PROFILE_FLOWIOS3)) || \
    ...
    (defined(FLOW_PROFILE_FLOWIOS3) && defined(FLOW_PROFILE_SUPERVISOR)) || \
    (defined(FLOW_PROFILE_FLOWIOS3) && defined(FLOW_PROFILE_FLOW_CONNECT_DISPLAY)) || \
    (defined(FLOW_PROFILE_FLOWIOS3) && defined(FLOW_PROFILE_MICRONOVA)) || \
...
#if !defined(FLOW_PROFILE_FLOWIO) && !defined(FLOW_PROFILE_FLOWIOS3) && !defined(FLOW_PROFILE_SUPERVISOR) && !defined(FLOW_PROFILE_FLOW_CONNECT_DISPLAY) && !defined(FLOW_PROFILE_MICRONOVA)
#error "A firmware profile macro must be defined."
#endif

#if defined(FLOW_PROFILE_FLOWIO)
#define FLOW_BUILD_IS_FLOWIO 1
#define FLOW_BUILD_IS_FLOWIOS3 0
...
#define FLOW_BUILD_IS_FLOWIOS3 1
#define FLOW_BUILD_IS_SUPERVISOR 0
#define FLOW_BUILD_IS_FLOW_CONNECT_DISPLAY 0
#define FLOW_BUILD_IS_MICRONOVA 0
#define FLOW_BUILD_PROFILE_NAME "FlowIOS3"
#endif
